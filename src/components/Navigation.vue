...
import { Search, Menu, X, Bookmark, Film, Compass, Home, Newspaper } from 'lucide-vue-next';
...
<template>
  ...
  >
    <nav class="container mx-auto px-4 md:px-8 max-w-7xl flex items-center justify-between">
      <RouterLink to="/" class="flex items-center gap-2">
        <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center">
          <Film class="w-5 h-5 text-primary-foreground" />
        </div>
        <span class="text-xl font-display tracking-wider text-foreground hidden sm:block">
          CINEMAX
        </span>
      </RouterLink>
...
>
  ...
  >
    ...
    >
      <div class="bg-background/95 backdrop-blur-xl border-b border-white/10 p-4">
